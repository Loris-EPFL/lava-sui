...
func TestSpecParsing(t *testing.T) {
	specJSON := `
		{
    "proposal": {
        "title": "Add Specs: Sui GraphQL",
        "description": "Adding new specification support for Sui's GraphQL API on Lava.",
        "specs": [
            {
                "index": "SUIGQL",
                "name": "sui graphql",
                ...
                "api_collections": [
                    {
                        ...
                        "collection_data": {
                            "api_interface": "rest",
                            "internal_path": "/graphql",
                            "type": "POST",
                            "add_on": ""
                        },
                        "apis": [
                            {
                                "name": "checkpoint.networkTotalTransactions",
                                "block_parsing": {
                                    "parser_arg": ["checkpoint.networkTotalTransactions"],
                        ...
                        "parse_directives": [
                            {
                                "function_tag": "GET_TOTAL_TRANSACTION_BLOCKS",
                                "function_template": "{\"query\":\"query { checkpoint { networkTotalTransactions } }\"}",
                                "result_parsing": {
                                    "parser_arg": ["checkpoint.networkTotalTransactions"],
                                    "parser_func": "PARSE_CANONICAL"
                                },
                                "api_name": "checkpoint.networkTotalTransactions"
                            },
                            {
                                "function_tag": "GET_TRANSACTION_BLOCK",
                                "function_template": "{\"query\":\"query { transactionBlock(digest: \\\"%s\\\") { gasInput { gasSponsor { address } gasPrice gasBudget } effects { status timestamp checkpoint { sequenceNumber } epoch { epochId referenceGasPrice } } } }\"}",
                                "result_parsing": {
                                    "parser_arg": ["transactionBlock"],
                                    "parser_func": "PARSE_CANONICAL"
                                },
                                "api_name": "transactionBlock"
                            },
                            {
                                "function_tag": "GET_BLOCKNUM",
                                "function_template": "{\"query\":\"query { block { number } }\"}",
                                "result_parsing": {
                                    "parser_arg": ["block.number"],
                                    "parser_func": "PARSE_CANONICAL"
                                },
                                "api_name": "block.number"
                            }
                        ],
                        "verifications": [
                            {
                                "name": "chain-id",
                                "parse_directive": {
                                    "function_template": "{\"query\":\"query { chainIdentifier }\"}",
                                    "function_tag": "VERIFICATION",
                                    "result_parsing": {
                                        "parser_arg": ["chainIdentifier"],
                                        "parser_func": "PARSE_BY_ARG",
                                        "encoding": "hex"
                                    },
                                    "api_name": "chainIdentifier"
                                },
                                "values": [
                                    {
